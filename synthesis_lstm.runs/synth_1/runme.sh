...
HD_PWD='D:/portfolio/synthesis_lstm/synthesis_lstm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_LSTM_cell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_LSTM_cell.tcl
